...
public class DrivingRouteOverLay extends RouteOverlay{
    ...
    private static String  TAG = "DrivingRouteOverLay";
    ...
    public DrivingRouteOverLay(Context context, AMap amap, DrivePath path,
                               LatLonPoint start, LatLonPoint end, List<LatLonPoint> throughPointList, MapContract.MapPresenter presenter) {
...
//                .snippet(driveStep.getInstruction())
                ...
                .anchor(0.5f, 0.5f).icon(getDriveBitmapDescriptor()),driveStep);
    }
    ...
    private BitmapDescriptor getThroughPointBitDes() {
    	return BitmapDescriptorFactory.fromResource(R.drawable.ic_roadmarker);
